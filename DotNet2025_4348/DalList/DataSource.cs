...
internal static class DataSource
{
    ...
    static internal List<Product> _products { get; set; } = new List<Product>
    {
        ...
        new Product(567891, "\" כי אשב בחושך ד' אור לי\"- \"לולי שישבתי בחושך לא היה ד' אור לי\"", Categorys.nisayon, 29.99, 70),
        new Product(678902, "-\t\"זה היום עשה ד' נגילה ונשמחה בו\"", Categorys.emona, 59.99, 80),
        new Product(789013, "יש צדיק גוזר וד' מקיים ודרגה גבוהה יותר - ד' גוזר וצדיק מקיים", Categorys.nisayon, 299.99, 10),
        new Product(890234, "יש ילד שמאכילים אותו בכפית, אבל כשגדלים לפעמים ד' רוצה שנאכל לבד, גם אם כל האוכל נשפך, זה שווה!", Categorys.nisayon, 15.99, 150),
        new Product(901345, "מה ישמח עכשיו את הקב\"ה?", Categorys.nisayon, 149.99, 90),
        new Product(123458, "והנה ד' ניצב עליו מלא כל הארץ כבודו מביט עליו ובוחן כליות ולב אם עבדו כראוי", Categorys.nisayon, 99.99, 100),
